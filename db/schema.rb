...
ActiveRecord::Schema[7.0].define(version: 2025_01_12_123001) do
  ...
  create_table "likes", charset: "utf8mb3", force: :cascade do |t|
    ...
    t.index ["user_id", "prototype_id"], name: "index_likes_on_user_id_and_prototype_id", unique: true
  ...
  create_table "notifications", charset: "utf8mb3", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["prototype_id"], name: "index_notifications_on_prototype_id"
  ...
  create_table "taggings", charset: "utf8mb3", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["prototype_id"], name: "index_taggings_on_prototype_id"
  ...
  add_foreign_key "notifications", "prototypes"
  add_foreign_key "notifications", "users"
  add_foreign_key "prototypes", "users"
  add_foreign_key "taggings", "prototypes"
